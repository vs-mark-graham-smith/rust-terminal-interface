...
const DB_PATH: &str = "/Users/markgraham-smith/Code/personal/me/self-learning/rust/terminal-interface2/data/db.json";
...
fn render_pets<'a>(pet_list_state: &ListState) -> (List<'a>, Table<'a>) {
    ...
    let pet_list = read_db().expect("can fetch pets list");
